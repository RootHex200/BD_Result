...
abstract class BtebResultRepository {
  ...
  Future<List<BtebGroupResultEntity>> getBtebGroupResult({required String startRoll,required String endRoll,required String semester,required String technology});
}